...
describe("Utils", () => {
  test("sleep", async () => {
    // In Node.js, setTimeout returns a Timeout object, not a number like in browsers
    // Just verify the promise resolves without error
    await expect(sleep(4)).resolves.toBeDefined();
  });
