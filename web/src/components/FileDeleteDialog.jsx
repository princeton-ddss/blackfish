...
import { deleteFile, getFileType } from "@/lib/fileApi";
                                ...
                                <div>
                                    ...
                                    {fileToDelete && (
                                        <div className="mt-4 rounded-md bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:flex sm:items-start">
                                            {(() => {
                                                const type = getFileType(fileToDelete.name);
                                                const iconClass = "h-8 w-8 text-gray-400 dark:text-gray-500 sm:h-6 sm:shrink-0";
